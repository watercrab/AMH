...
interface IConfirmSendActivityModal {
  isOpen: boolean;
  handleAddActivity: () => Promise<void>;
  closeModal: () => void;
}

const ConfirmSendActivityModal = ({
  isOpen,
  handleAddActivity,
  closeModal,
}: IConfirmSendActivityModal) => {
  return (
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform space-y-5 overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                >
                  คุณต้องการส่งรูปภาพนี้ใช่หรือไม่
                </Dialog.Title>
                <div
                  className={clsx(
                ...
                >
                  ...
                  <Button variant="milk-pink" onClick={closeModal}>
                    ไม่ใช่
                  </Button>
                </div>
              </Dialog.Panel>
...
export default ConfirmSendActivityModal;
